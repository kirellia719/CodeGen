...
class ClassType(Type):
    ...
    def __str__(self):
        return "ClassType({})".format(self.name)
...
class FuncDecl(Decl):
    ...
    def __str__(self):
        return "FuncDecl({}, {}, [{}], {}, {})".format(self.name, str(self.returnType), ", ".join([str(param) for param in self.params]), self.inherit if self.inherit else "None", str(self.body))
